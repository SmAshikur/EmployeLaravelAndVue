                ...
                @foreach ($countries as $country )
                    <tr>
                        ...
                        <td class="d-flex justify-content-around">
                            <div><a class="btn btn-warning " href="{{route('country.edit',$country)}}">Edit</a></div>
                            <div>
                                <form method="POST" action="{{route('country.destroy',$country)}}"> @csrf
